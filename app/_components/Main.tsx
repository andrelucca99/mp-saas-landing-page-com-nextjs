  ...
  return (
    <main>
      <section className="flex flex-col items-center text-center py-8 md:py-16">
        <h1 className="md:text-6xl text-2xl font-bold">Simplifique Seus Estudos </h1>
      ...
      <section className="bg-white py-8 md:py-16">
        <div className="container mx-auto">
          <h2 className="font-bold text-xl md:text-4xl text-center">Como funciona?</h2>
      ...
      <section className="py-8 md:py-16 text-center px-2 md:px-0">
        <h2 className="font-bold text-xl md:text-6xl">Preço Simples e Transparente</h2>
      ...
      <section className="bg-white py-8 md:py-16 text-center px-2 md:px-0">
        <h2 className="font-bold text-xl md:text-6xl">Pronto Para Mudar Sua Vida?</h2>
